...
def test_google_keep_checklist_item_filtering_supports_item_only(tmp_path):
    note_path = tmp_path / "note.json"
    write_note(note_path, {"id": "note-1", "title": "Trip", "listContent": [{"text": "Pack", "isChecked": True}]})
