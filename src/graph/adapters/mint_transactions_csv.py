...
class MintTransactionsCsvAdapter(SourceAdapter):
    ...
    def _unit(self, row: dict[str, Any], source_file: str, index: int) -> KnowledgeUnit | None:
        ...
        if not any([transaction_id, date_text, description, original_description, raw_amount is not None, category, account, labels, notes]):
            return None
        ...
        return KnowledgeUnit(
            source_project=SourceProject.MINT_TRANSACTIONS_CSV,
