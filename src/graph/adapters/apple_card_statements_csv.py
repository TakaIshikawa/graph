"""Adapter for Apple Card statement CSV exports."""
...
class AppleCardStatementsCsvAdapter(SourceAdapter):
    @property
    def name(self) -> str:
        return "apple_card_statements_csv"
