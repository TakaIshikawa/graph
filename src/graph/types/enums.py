...
class SourceProject(StrEnum):
    ...
    HYPOTHESIS_ANNOTATIONS_JSON = "hypothesis_annotations_json"
    ...
    PRODUCT_HUNT_VOTES_JSON = "product_hunt_votes_json"
    READWISE_READER_DOCUMENTS_CSV = "readwise_reader_documents_csv"
    ...
    GOOGLE_TASKS_JSON = "google_tasks_json"
    ...
    DISCORD_SAVED_MESSAGES_JSON = "discord_saved_messages_json"
    ...
    GITHUB_RELEASES_JSON = "github_releases_json"
    GITHUB_PULL_REQUESTS_JSON = "github_pull_requests_json"
    GITHUB_COMMITS_JSON = "github_commits_json"
    ...
    LINEAR_ISSUES_CSV = "linear_issues_csv"
